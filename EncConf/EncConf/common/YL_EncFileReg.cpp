...
void YL_EncFileReg::MakeDefaultConf()
{
	string strPath;
	...
	{
		YL_EncFileReg::WriteString( "Layout", "Height", "500" );
		YL_EncFileReg::WriteString( "Layout", "Width", "919" );
		YL_EncFileReg::WriteString( "Layout", "mincx", "800" );
		YL_EncFileReg::WriteString( "Layout", "mincy", "500" );
		YL_EncFileReg::WriteString( "Layout", "xPos", "50" );
		YL_EncFileReg::WriteString( "Layout", "yPos", "75" );
		YL_EncFileReg::WriteString( "Layout", "Normal", "1" );

		YL_EncFileReg::WriteString( "Setting", "HomePage", "http://box.7k7k.com/client/" );
		YL_EncFileReg::WriteString( "Setting", "ColorUser", "16777215" );
		YL_EncFileReg::WriteString( "Setting", "changeColorLight", "120" );
		YL_EncFileReg::WriteString( "Setting", "askexit", "0" );
		YL_EncFileReg::WriteString( "Setting", "exitchoice", "0" );
		YL_EncFileReg::WriteString( "SkinSub", "CurSub", "tiger" );
		YL_EncFileReg::WriteString( "SkinSub", "Color", "0,0,0" );
	}
}
