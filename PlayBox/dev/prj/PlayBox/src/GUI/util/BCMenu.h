...
//added by vito--
	void SetMenuItemBkColor( COLORREF col ); 
	void SetMenuItemBitmapBkColor( COLORREF col ); 
	void SetTextColor(COLORREF col);
	void SetMenuItemBitmap( UINT nID, LPCTSTR text, LPCSTR bitmap );
	void SetMenuItemBitmap(UINT nID, LPCTSTR text, HBITMAP bitmap );
//--
...
//added by vito--
public:
	COLORREF m_menuItemBkColor;
	COLORREF m_menuItemBitmapBkColor;
	COLORREF m_menuItemTextColor;
	COLORREF m_menuItemSelectBKColor;
//--
}; 
