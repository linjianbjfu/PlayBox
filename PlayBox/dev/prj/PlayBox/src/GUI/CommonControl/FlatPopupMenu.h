...
// kill message circulate bug by Peng.Zhou<zhp21@163.com>
...
public:
  ...
  UINT GetMsg(){return m_msg;}
  void SetDibBitmap( CDibBitmap* bmp){m_pBitmap=bmp;}
	UINT m_msg;
