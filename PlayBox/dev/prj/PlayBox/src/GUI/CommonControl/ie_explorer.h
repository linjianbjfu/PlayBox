...
public:
	...
	void NavigateImage(CString strImagePath, long ImageWidth, long ImageHeight);
	void SetFlatStyle();
	afx_msg void CWebBrowser::OnDocumentComplete(LPDISPATCH lpDisp, VARIANT FAR* URL);
// 属性
public:
enum
{
...
// Properties
private:
	HRESULT Writeln(IHTMLDocument2* pDoc, CString text);
};
