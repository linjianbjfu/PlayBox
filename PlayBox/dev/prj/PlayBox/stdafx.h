...
#include "./src/Global/GlobalVariable.h"
#include "./src/Global/GlobalFunction.h"
#include "./src/Core/IMessageManager.h"

#include "./src/Core/MessageID.h"
#include "./src/Core/IDataManager.h"
#include "./src/DataInterface/DataObjectID.h"
