...
软件启动时自动弹出mini框	高朝华
安装完毕后捆绑桌面快捷方式图标	高朝华
已经下载过的小游戏也保留5秒钟的广告展示时间	高朝华
360审核	程序中地址栏取消，保留前进后退基本浏览器操作	高朝华
软件设置中添加是否弹出mini框	高朝华
360认证白名单账户通过审核	李幸
软件优化	去掉程序中新开窗口+号，增加固定的热点资讯标签	高朝华
小游戏播放界面右侧信息栏展示\隐藏的小图标效果优化	高朝华
后续优化	多进程相关静音、暂停、加速功能	林建



明示升级的update.cpp部分不能用
userid,qd, ver放在$APPDATA\PP\user_conf.ini
